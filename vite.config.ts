        ...
        if (url.startsWith('/api/products')) {
          ...
          if (productId && req.method === 'PUT') {
            ...
            products[targetIdx] = {
              ...
              brand: payload.brand !== undefined ? payload.brand : products[targetIdx].brand,
              model: payload.model !== undefined ? payload.model : products[targetIdx].model,
              vendor: payload.vendor !== undefined ? payload.vendor : products[targetIdx].vendor,
